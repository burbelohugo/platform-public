...
const insert_profile = {
    body: JSON.stringify({
        ...
        group: "hacker",
        user_id: "1234",
        hacker_profile: {name: "Anna Feng", school: "UMDCP", year: "freshman", linkedin: "sdfjks", email: "test@example.com"}
    })
};
...
const final = {
    ...
    group: "hacker",
    user_id: "1234",
    hacker_profile: {year: "sophomore", email: "test@example.com"}
};

const no_hacker_profile = {
    body: JSON.stringify({
        "user_id": "1234",
        "missing_hacker_profile": {year: "sophmore", email: "test@example.com"}
    })
};
